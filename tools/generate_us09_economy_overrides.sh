...
Options:
  ...
  --building-maintenance-multiplier N    Non-trade maintenance quantity multiplier (default: 0.3)
...
building_maintenance_multiplier="${MODEU5_US08_BUILDING_MAINTENANCE_MULTIPLIER:-0.3}"
