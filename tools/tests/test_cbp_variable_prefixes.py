    ...
    def test_manifest_owned_cbg_outputs_are_not_scanned(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            generated_without_manifest = (
                package / "in_game/common/disasters/cbp_generated_disaster.txt"
            )
            generated_without_manifest.parent.mkdir(parents=True, exist_ok=True)
            generated_without_manifest.write_text(
                "# Generated by the CBP political/minting CBG adapter.\n"
                "# Do not edit manually.\n"
                "# Vanilla source: in_game/common/disasters/test.txt\n\n"
                "test = {\n\tset_variable = another_vanilla_variable\n}\n",
                encoding="utf-8",
            )
        ...
        self.assertNotIn(generated_without_manifest, files)
