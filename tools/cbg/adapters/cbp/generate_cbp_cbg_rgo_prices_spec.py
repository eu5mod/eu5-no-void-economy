...
def build_spec(game_root: Path, percent: Decimal) -> dict[str, object]:
    """Build the retained percentage-offset policy."""
...
def main() -> int:
    ...
    parser.add_argument(
        "--fixed-price",
        type=Decimal,
        default=Decimal(os.environ.get("MODEU5_US09_RGO_FIXED_PRICE", "60")),
        help="Fixed price used by the fixed adapter; defaults to MODEU5_US09_RGO_FIXED_PRICE or 60.",
    )
    ...
    print(f"Generated {display_path(args.output)} with US-09 RGO-price adapter: {policy}.")
    return 0
