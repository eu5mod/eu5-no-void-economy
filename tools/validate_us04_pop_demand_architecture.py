...
def main() -> int:
    ...
    q9_test = read("packages/cbp_core_tests_q9/in_game/common/scripted_effects/cbp_us04_q9_replace_pop_demand_test_effects.txt")
    q9_debug_events = read("packages/cbp_core_tests_q9/in_game/events/cbp_us04_q9_debug_events.txt")
    ...
    expect(not any((ROOT / "packages/cbp_core_tests_q9/in_game/common/goods_demand").glob("zz_cbp_us04_probe_*.txt")), "Archived invalid-syntax US-04 pop_demand probes must not live in a loadable test package")
