...
modifiers_output="${2:-$repo_root/in_game/common/modifiers/modeu5_us00_modifiers_generated.txt}"
...
mkdir -p "$(dirname "$output")" "$(dirname "$modifiers_output")"
...

{
	printf '%s\n' '# Generated by tools/generate_stock_good_helpers.sh.'
	printf '%s\n' '# Do not edit manually.'
	printf '%s\n\n' '# One static modifier per good so add_location_modifier can use literal identifiers.'
	for good in "${goods[@]}"; do
