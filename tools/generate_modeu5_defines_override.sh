...
usage() {
	cat <<'EOF_USAGE'
Usage: bash ./tools/generate_modeu5_defines_override.sh [options]
...
header_lines = [
    "# Generated by tools/generate_modeu5_defines_override.sh.",
...
if check_mode:
    ...
    if output_file.read_bytes() != expected_bytes:
        raise SystemExit(
            ...
            "bash ./tools/generate_modeu5_defines_override.sh."
        )
