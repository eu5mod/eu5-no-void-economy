    ...
    subgraph LOOP_COUNTRY["Loop: monthly_country_pulse / current country"]
        ...
        subgraph LOOP_MARKET_CENTER["Loop: every_market_center_in_country<br/>market-center-owned local branch"]
            ...
            subgraph LOOP_COUNTRIES_CAP_US00["Loop: every_in_global_list modeu5_countries_present_in_market<br/>Q4.1 fused capacity + US-00 pass"]
                ...
                subgraph LOOP_US00_GOODS["Loop: generated goods expansion<br/>US-00 active-good guards"]
                    direction TB
                    U1 --> U2["modeu5_pr71_process_us00_monthly_market_good_GOOD"]
                    U2 --> U3{"produced in market<br/>or previous US-00 state?"}
            ...
            subgraph LOOP_COUNTRIES_US10["Loop: every_in_global_list modeu5_countries_present_in_market<br/>US-10 pending-request pass"]
                direction TB
                U6 --> S0["for each present country"]
                S0 --> S1["modeu5_pr71_process_us10_monthly_market_pending_goods"]

                subgraph LOOP_US10_GOODS["Loop: generated goods expansion<br/>US-10 pending-request guards"]
                    direction TB
            ...
            S6 --> L9["record local market processed"]
