...
flowchart TD
    subgraph LOOP_COUNTRY[Loop: monthly_country_pulse / current country]
        ...
        subgraph LOOP_CAP_MARKET[Loop: every_market_present_in_country<br/>current-country capacity split]
            ...
            CAP0 --> CAP1[count markets for pool divisor]
            CAP1 --> CAP2[store country-market capacity records]
        end

        CAP0 -. reads .-> CAPD0[country location-capacity pool]
        subgraph LOOP_CAP_POOL[Dependency loop: every_owned_location<br/>pool rebuild outside the hot monthly split]
            CAPD1[modeu5_rebuild_country_location_capacity_pool] --> CAPD2[sum owned-location rank capacity]
        ...
        subgraph LOOP_MARKET_CENTER[Loop: every_market_center_in_country<br/>market-center-owned local branch]
            ...
            subgraph LOOP_MARKET_LOC[Loop: every_location_in_market<br/>rebuild countries_present_in_market]
                ...
                M1 --> M2[location owner link -> country]
