...
On branch pushes, the workflow generates adjacent `.dds` copies for committed `.svg`, `.png`, `.jpg`, and `.jpeg` files under `docs/assets/`, then commits the generated DDS files back to the branch.
