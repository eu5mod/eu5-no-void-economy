...
| 015 | US-01 | Current country stock in market for good | country × market × good logical record | logical `stock` field; physical country-scoped `modeu5_<good>_stock_by_market` map keyed by market | internal record field / variable map | ModeU5; TECH-01 007 | CONFIRMED | N/A | Logical name remains `country_market_good_stock`. Only centralized stock effects may write the physical field map. Missing entries default explicitly to zero. |
| 016 | US-01 | Market stock for good | market × good | market-scoped `modeu5_market_good_stock` map keyed by goods scope | internal variable map | ModeU5; TECH-01 007 | CONFIRMED | N/A | Logical name remains `market_good_stock`. This is an aggregate/cache rebuilt only from country stock maps. |
| 017 | US-01 | Country stock capacity | country × market × good logical record | logical `capacity` field; physical country-scoped `modeu5_<good>_stock_cap_by_market` map keyed by market | internal record field / variable map | ModeU5; TECH-01 007 | CONFIRMED | N/A | Logical name remains `country_market_good_stock_cap`. Missing entries default explicitly to zero. |
