...
|---:|---|---|---|---|
| 010 | Dynamically apply a temporary location modifier | US-00.3, EPIC US-00 | Apply the good-specific or general production penalty to affected locations | Keep the penalty theoretical/debug-only. |
| 011 | Recurring monthly on_action | US-03, US-09, US-10.3, EPIC US-10, US-11 | Automatically run monthly decay, compensation, counter resets, demand resolution, and validation | Use a deterministic event pulse only after one fallback is accepted. |
| 012 | Recurring yearly on_action | US-04, US-10.3, EPIC US-10, US-11 | Automatically run annual demand adaptation, annual counter reads/resets, and validation | Use a deterministic event pulse only after one fallback is accepted. |
| 021 | Source-level building/RGO production quantity with ledger attribution | US-00.1, EPIC US-00, US-00-UI, US-01 | Measure production before stock insertion at the required source granularity | Use one explicit source-level production estimate if accepted. |
| 036 | Monthly decay pulse | US-03 | Invoke decay automatically each month | Same monthly event-pulse fallback as 011; do not create a second mechanism. |
...
| 041 | Read current Stability/Court slider cost | US-05, US-05-UI | Compare vanilla cost with the ModeU5 target and calculate reconciliation | Debug-only target calculation until a readable value is confirmed. |
| 043 | Read country wealth | US-05, US-05-UI | Calculate the required `Wealth + Trade Income` slider base | Use one accepted ModeU5 reconstructed/estimated wealth value. |
| 044 | Replace the slider cost base directly | US-05, US-05-UI | Make Stability and Court costs use the ModeU5 base natively | Use monthly reconciliation if accepted. |
| 045 | Present slider reconciliation visibly | US-05, US-05-UI | Ensure any slider correction is player-visible | Use a debug report if no safe visible gameplay effect is confirmed. |
...
| 081 | Identify the country credited with building/RGO output | US-00.1, US-00.3, EPIC US-00, US-00-UI, US-01 | Assign produced stock and penalties to the economically credited country | No fallback selected; do not assume location owner or building owner universally. |
